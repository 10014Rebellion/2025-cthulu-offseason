...
public class Pivot extends SubsystemBase{
    ...
    private LoggedTunableNumber kTuneableP = new LoggedTunableNumber("Intake/Pivot/Tuneables/kP", 0.0);
    private LoggedTunableNumber kTuneableI = new LoggedTunableNumber("Intake/Pivot/Tuneables/kI", 0.0);
    private LoggedTunableNumber kTuneableD = new LoggedTunableNumber("Intake/Pivot/Tuneables/kD", 0.0);
    private LoggedTunableNumber kTuneableVelocity = new LoggedTunableNumber("Intake/Pivot/Tuneables/kVelocity", 0.0);
    private LoggedTunableNumber kTuneableAccel = new LoggedTunableNumber("Intake/Pivot/Tuneables/kAccel", 0.0);
    private LoggedTunableNumber kTuneableS = new LoggedTunableNumber("Intake/Pivot/Tuneables/kS", 0.0);
    private LoggedTunableNumber kTuneableV = new LoggedTunableNumber("Intake/Pivot/Tuneables/kV", 0.0);
    private LoggedTunableNumber kTuneableG = new LoggedTunableNumber("Intake/Pivot/Tuneables/kG", 0.0);
