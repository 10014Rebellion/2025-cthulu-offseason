...
public class ButtonBindings{
    ...
    public void initDriverButtons() {
        ...
        mDriverController
            .rightBumper()
            .whileTrue(mTeleopCommands.getIntakeCoralCmd());

        mDriverController
            .rightTrigger()
            .whileTrue(mTeleopCommands.getIntakeFloorAlgaeCmd());
        
    }
    // All bindings for the operator should be here.
    public void initOperatorBindings() {
        mOperatorController.a().whileTrue(
            mTeleopCommands.scoreProcessorCmd()
        );
    }
    ...
    public void initTestBindings() {
        ...
        mDriverController.rightTrigger().whileTrue(
            mFlywheels.setTopFlywheelRPM(6000)
        );
        mDriverController.leftTrigger().whileTrue(
            mFlywheels.setBottomFlywheelRPM(6000)
        );
    }   
